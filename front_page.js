...
function randomizeBackground() {
	...
	var trainImage = 'url(http://localhost:3000/green/train/train' + trainRandom + '.jpg)'
	$('#train').css("background-image", trainImage)
	var airplaneRandom = Math.floor(Math.random() * 5)
	var airplaneImage = 'url(http://localhost:3000/green/airplane/airplane' + trainRandom + '.jpg)'
